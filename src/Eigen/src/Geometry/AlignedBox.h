...
/** \geometry_module \ingroup Geometry_Module
  ...
  */
  ...
  public:
    ...
    inline AlignedBox() { if (AmbientDimAtCompileTime != Dynamic) setEmpty(); }
    ...
    center() const { return (m_min + m_max) / 2; }

    /** \returns the lengths of the sides of the bounding box.
      * Note that this function does not get the same
      * result for integral or floating scalar types: see
      */
    inline const CwiseBinaryOp<internal::scalar_difference_op<Scalar>, const VectorType, const VectorType>
