...
/** \geometry_module \ingroup Geometry_Module
  ...
  */
  ...
  public:
    ...
    template<class OtherDerived> EIGEN_STRONG_INLINE Derived
    &
...
//  { return operator=<Derived>(other); }
    ...
    */
    template<class OtherDerived>
    inline Scalar dot(const QuaternionBase<OtherDerived> &other) const { return coeffs().dot(other.coeffs()); }
    ...
    template<class OtherDerived> EIGEN_STRONG_INLINE Quaternion<Scalar>
...
class Quaternion : public QuaternionBase<Quaternion<_Scalar, _Options> > {
  ...
  enum {
    IsAligned = internal::traits<Quaternion>::IsAligned
  };
...
public:
  ...
  /** Copy constructor */
  template<class Derived>
  EIGEN_STRONG_INLINE Quaternion(const QuaternionBase <Derived> &other) { this->Base::operator=(other); }
  ...
  explicit inline
  Quaternion(const Quaternion<OtherScalar, OtherOptions> &other) { m_coeffs = other.coeffs().template cast<Scalar>(); }
...
namespace internal {
  template<typename _Scalar, int _Options>
  struct traits<Map < Quaternion<_Scalar>, _Options> > : traits<Quaternion<_Scalar,
...
namespace internal {
  ...
  struct quat_product {
    static EIGEN_STRONG_INLINE Quaternion<Scalar>
