...
/** \geometry_module \ingroup Geometry_Module
  ...
  */
  ...
  public:
    ...
    operator*(const MatrixBase <Derived> &vec) const { return m_coeffs + vec.derived(); }
    ...
    inline explicit
    Translation(const Translation<OtherScalarType, Dim> &other) { m_coeffs = other.vector().template cast<Scalar>(); }
