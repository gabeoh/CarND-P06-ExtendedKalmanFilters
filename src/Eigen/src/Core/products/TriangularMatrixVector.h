...
struct TriangularProduct<Mode, true, Lhs, false, Rhs, true>
  ...
  void scaleAndAddTo(Dest &dst, const Scalar &alpha) const {
    ...
    internal::trmv_selector<(int(internal::traits<Lhs>::Flags) & RowMajorBit) ? RowMajor : ColMajor>::run(*this, dst,
                                                                                                          alpha);
  }
};
...
void scaleAndAddTo(Dest &dst, const Scalar &alpha) const {
  ...
  typedef TriangularProduct<(Mode & (UnitDiag | ZeroDiag)) | ((Mode & Lower) ? Upper
                                                                             : Lower), true, Transpose<const Rhs>, false, Transpose<const Lhs>, true> TriangularProductTranspose;
...
// TODO: find a way to factorize this piece of code with gemv_selector since the logic is exactly the same.
  ...
  struct trmv_selector<ColMajor> {
    ...
    static void run(const TriangularProduct<Mode, true, Lhs, false, Rhs, true> &prod, Dest &dest,
