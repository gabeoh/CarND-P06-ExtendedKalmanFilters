...
//   conj_helper<LhsPacket,RhsPacket,ConjLhs,ConjRhs> pcj;
    ...
    public:
      ...
      EIGEN_STRONG_INLINE void
      madd(const LhsPacket &a, const RhsPacket &b, DoublePacket &c, RhsPacket & /*tmp*/) const {
 ...
 */
    ...
    struct gebp_kernel {
      ...
      EIGEN_DONT_INLINE
      void operator()(ResScalar *res, Index resStride, const LhsScalar *blockA, const RhsScalar *blockB, Index rows,
    ...
    ::operator()(ResScalar *res, Index resStride, const LhsScalar *blockA, const RhsScalar *blockB, Index rows,
                 Index depth, Index cols, ResScalar alpha,
...
//  36 36 38 39 ...
    ...
    struct gemm_pack_lhs {
      ...
      operator()(Scalar *blockA, const Scalar *EIGEN_RESTRICT _lhs, Index lhsStride, Index depth, Index rows,
...
//  .  .  .  .    .  .  .  .    .  .
    ...
    struct gemm_pack_rhs<Scalar, Index, nr, ColMajor, Conjugate, PanelMode> {
      ...
      EIGEN_DONT_INLINE void
      operator()(Scalar *blockB, const Scalar *rhs, Index rhsStride, Index depth, Index cols, Index stride = 0,
                 Index offset = 0);
    };

    template<typename Scalar, typename Index, int nr, bool Conjugate, bool PanelMode>
    EIGEN_DONT_INLINE void gemm_pack_rhs<Scalar, Index, nr, ColMajor, Conjugate, PanelMode>
    ::operator()(Scalar *blockB, const Scalar *rhs, Index rhsStride, Index depth, Index cols, Index stride,
                 Index offset) {
