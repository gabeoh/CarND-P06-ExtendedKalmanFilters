...
#undef EIGEN_CURRENT_STORAGE_BASE_CLASS
    ...
    template<bool Enable> inline typename internal::add_const_on_value_type<typename internal::conditional<Enable,
        ForceAlignedAccess < Derived>, Derived &>::type>

    ::type forceAlignedAccessIf() const;

    template<bool Enable> inline typename internal::conditional<Enable, ForceAlignedAccess < Derived>,Derived&>
...
/////////// Geometry module ///////////
    ...
    enum {
      HomogeneousReturnTypeDirection = ColsAtCompileTime == 1 ? Vertical : Horizontal
    };
