...
/** \class PlainObjectBase
  ...
  */
  ...
  public:
    ...
    template<typename PlainObjectType, int MapOptions, typename StrideType> friend
    class Eigen::Map;
  ...
  public:
    enum {
      NeedsToAlign = SizeAtCompileTime != Dynamic && (internal::traits<Derived>::Flags & AlignedBit) != 0
    };
...
//       EIGEN_INITIALIZE_COEFFS_IF_THAT_OPTION_IS_ENABLED
    ...
    EIGEN_STRONG_INLINE PlainObjectBase(const EigenBase <OtherDerived> &other)
        : m_storage(Index(other.derived().rows()) * Index(other.derived().cols()), other.derived().rows(),
                    other.derived().cols()) {
      _check_template_params();
    ...
    MapAligned(const Scalar *data, Index rows, Index cols) { return ConstAlignedMapType(data, rows, cols); }
    ...
    static inline typename StridedConstMapType<Stride < Outer, Inner> >
    ...
    template<int Outer, int Inner>
    static inline typename StridedMapType<Stride < Outer, Inner> >

    ::type Map(Scalar *data, const Stride <Outer, Inner> &stride) {
    ...
    ::type Map(Scalar *data, Index size, const Stride <Outer, Inner> &stride) {
    ...
    ::type Map(Scalar *data, Index rows, Index cols, const Stride <Outer, Inner> &stride) {
      return typename StridedMapType<Stride<Outer, Inner> >::type(data, rows, cols, stride);
    }

    template<int Outer, int Inner>
    static inline typename StridedConstAlignedMapType<Stride < Outer, Inner> >
    ...
    template<int Outer, int Inner>
    static inline typename StridedAlignedMapType<Stride < Outer, Inner> >
...
#include EIGEN_PLAINOBJECTBASE_PLUGIN
  ...
  protected:
    ...
    EIGEN_STRONG_INLINE Derived &_set(const DenseBase <OtherDerived> &other) {
      _set_selector(other.derived(), typename internal::conditional<static_cast<bool>(int(OtherDerived::Flags) &
    ...
    _init2(Index nbRows, Index nbCols, typename internal::enable_if<Base::SizeAtCompileTime != 2, T0>::type * = 0) {
    ...
    template<typename T0, typename T1>
    EIGEN_STRONG_INLINE void _init2(const Scalar &val0, const Scalar &val1,
    ...
    void _swap(DenseBase <OtherDerived> const &other) {
      enum {
        SwapPointers = internal::is_same<Derived, OtherDerived>::value && Base::SizeAtCompileTime == Dynamic
      };
      internal::matrix_swap_impl<Derived, OtherDerived, bool(SwapPointers)>::run(this->derived(),
                                                                                 other.const_cast_derived());
    }
