  ...
  */
    ...
    void conjugate_gradient(const MatrixType &mat, const Rhs &rhs, Dest &x,
      ...
      while (i < maxIters) {
        ...
        RealScalar beta =
            absNew / absOld;            // calculate the Gram-Schmidt value used to create the new search direction
  ...
  public:
    ...
    void _solveWithGuess(const Rhs &b, Dest &x) const {
      ...
      for (int j = 0; j < b.cols(); ++j) {
        ...
        internal::conjugate_gradient(MatrixWrapperType(*mp_matrix), b.col(j), xj, Base::m_preconditioner, m_iterations,
                                     m_error);
      }
