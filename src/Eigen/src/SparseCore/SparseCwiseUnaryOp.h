...
public:
  ...
  EIGEN_STRONG_INLINE typename CwiseUnaryOpImpl::Scalar

  value() const { return m_functor(Base::value()); }
...
public:
  ...
  EIGEN_STRONG_INLINE typename CwiseUnaryViewImpl::Scalar
  ...
  valueRef() { return m_functor(Base::valueRef()); }
